...
public class Weapon extends Item {
  ...
  public Weapon(String name, ItemSkin skin, Position position, int damage) {
  ...
  public static Weapon valueOf(Map<String, String> attributes) {
    ...
    return new Weapon(attributes.get("name"), ItemSkin.valueOf(attributes.get("skin").toUpperCase()),
